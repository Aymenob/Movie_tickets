...
$(document).ready(function () {
    ...
    $('.support-topic-block').on('click', function (e) {
        ...
        $.ajax({
            url: base_url + "Users_controller/tickets_availability" + "/" + date + "/" + cinema_id + "/" + movie_id,
            type: "GET",
            dataType: 'json',
            success: function ($data) {
                ...
                $('#butsave').attr("quantity-id", $Data["place_dispo"]);
            }
        });
    ...
    $('#butsave').on('click', function (e) {
        ...
        $.ajax({
            url: base_url + "Users_controller/tickets_purchase" + "/" + projection_id + "/" + nbr_tickets + "/" + place_dispo,
            type: "GET",
            dataType: 'json',
