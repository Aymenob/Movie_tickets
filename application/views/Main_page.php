                            ...
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href=<?php echo base_url('Users_controller/login_page');?> href="html/general/pages/auths/auth-login.html" class="nk-menu-link" target="_blank"><span class="nk-menu-text">Login / Signin</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href=<?php echo base_url('Users_controller/cinema_page/'.$sale['cinema_id']);?> target="_blank" class="nk-menu-link"><span class="nk-menu-text"><?php echo $sale['nom_cinema'];?> </span></a>
                                        </li>
                                        <?php };?>
                                    </ul><!-- .nk-menu-sub -->
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu">
                                                                        <ul class="link-list-plain">
                                                                            <li><a href=<?php echo base_url("users_controller/cinema_availability/".$Movie['film_id'] )?>>réserver</a></li>
